//
//  KZWorkScheduleStarController.m
//  KKXC_Franchisee
//
...
@interface KZWorkScheduleStarController ()<UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource, DZNEmptyDataSetDelegate>
{
    int currentpage;
...
@implementation KZWorkScheduleStarController
