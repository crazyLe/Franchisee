...
@interface KZWorkScheduleEndController ()<UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource, DZNEmptyDataSetDelegate>
{
    int currentpage;
...
@implementation KZWorkScheduleEndController
