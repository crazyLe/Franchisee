...
#define selectedTitleAndIndicatorViewColor [UIColor colorWithHexString:@"1d86e1"]
...
- (void)setStaticTitleArr:(NSArray *)staticTitleArr {
    ...
    for (NSInteger j = 0; j < self.staticTitleArr.count; j++) {
        ...
        _staticTitleLabel.textColor = [UIColor colorWithHexString:@"#999999"];
    ...
    // 添加指示器
    self.indicatorView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"btn_selected"]];
//    _indicatorView.backgroundColor = selectedTitleAndIndicatorViewColor;
//    _indicatorView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"btn_selected"]];
//    _indicatorView.SG_height = indicatorHeight;
//    _indicatorView.SG_y = self.frame.size.height - indicatorHeight;
    self.indicatorView.contentMode = UIViewContentModeScaleAspectFill;
...
//    _indicatorView.SG_centerX = firstLabel.SG_centerX;
    _indicatorView.frame = firstLabel.frame;
}
...
//    _selectedTitleLabel.textColor = [UIColor blackColor];
    ...
    _selectedTitleLabel.textColor = [UIColor colorWithHexString:@"#999999"];
...
//        aFrame.size.width += 60;
//        aFrame.origin.x -= 30;
        self.indicatorView.frame = label.frame;
    }];
}
